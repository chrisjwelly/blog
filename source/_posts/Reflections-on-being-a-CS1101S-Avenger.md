...
What I have above is a bit of a toy problem, but this can be generalised to many other cases. For example, programming a Knight piece in chess. The nice thing about this method is its flexibility in defining the directions. It may be slightly error prone in terms of whether you should access `dy` or `dx` first, but that aside I was pretty impressed by this technique.
